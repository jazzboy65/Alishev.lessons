...
- Удаление элементов, добавление элементов в начало листа - LinkedList
 ...
 Linked List бывает 2 типов:
 1)Single Linked List - есть ссылка только на следующий элемент
 2)Double Linked List - есть ссылка на предыдущий, а также на следующий элемент
 */
